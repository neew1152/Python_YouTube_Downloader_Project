...
class YouTubeDownloaderApp(customtkinter.CTk):
    def __init__(self):
        ...
        # Window Setup
        self.title("Python Youtube Downloader Release 2.5")
    ...
    def _download_best_thread(self, url: str, custom_filename: str):
        try:
            ...
            is_playlist = bool(raw_title) and raw_title.strip() != "NA"
            ...
            if is_playlist:
                ...
                name_template = f"{clean_custom_name}_%(autonumber)03d.%(ext)s" if clean_custom_name else "%(playlist_index)03d_%(title)s.%(ext)s"

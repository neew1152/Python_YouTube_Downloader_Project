...
def search_function():
    url = url_input.get()
    error_icon = Image.open("Icons/error_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
    check_icon = Image.open("Icons/check_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
    try:
        ...
        search_button.configure(image=CTkImage(light_image=check_icon))
        app.update()
        ...
        search_button.configure(image=CTkImage(light_image=error_icon))
        app.update()
app.update()
...
# Search Button
search_icon = Image.open("Icons/search_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
search_button = customtkinter.CTkButton(video_and_audio_scroll_frame, text="Search", font=(os_font, os_font_size), fg_color="#297CD2", hover_color="#21A366", image=CTkImage(light_image=search_icon), height=20, command=search_function)
search_button.pack()
app.update()
...
def download_function(url, ID, name_file):
    downloading_icon = Image.open("Icons/downloading_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
    error_icon = Image.open("Icons/error_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
    ...
    try:
        ...
        for line in process.stdout:
            ...
            download_button.configure(image=CTkImage(light_image=downloading_icon))
            app.update()
        ...
        if errors_output:
            ...
            download_button.configure(image=CTkImage(light_image=error_icon))
            app.update()
...
download_icon = Image.open("Icons/download_1000dp_5F6368_FILL0_wght400_GRAD0_opsz48.png")
download_button = customtkinter.CTkButton(video_and_audio_scroll_frame, text="Download", font=(os_font, os_font_size), fg_color="#297CD2", hover_color="#21A366", image=CTkImage(light_image=download_icon), height=20, command=download)
